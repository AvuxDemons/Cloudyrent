...
export function usePaginatedCatalog<T = any>(options: UsePaginatedQueryOptions<T> = {}) {
    return usePaginatedQuery<T>("catalog", {
...
export function usePaginatedBrands<T = any>(options: UsePaginatedQueryOptions<T> = {}) {
    return usePaginatedQuery<T>("brands", {
        searchFields: ["name"],
        orderBy: "created_at",
        orderDirection: "desc",
        ...options
...
export function usePaginatedSeries<T = any>(options: UsePaginatedQueryOptions<T> = {}) {
    return usePaginatedQuery<T>("series", {
        searchFields: ["name"],
        orderBy: "created_at",
        orderDirection: "desc",
        ...options
...
export function usePaginatedCharacters<T = any>(options: UsePaginatedQueryOptions<T> = {}) {
    return usePaginatedQuery<T>("characters", {
        searchFields: ["name"],
        orderBy: "created_at",
        orderDirection: "desc",
        ...options,
        select: "*, series:series(*)" // Include series join
    });
}

export function usePaginatedTransactions<T = any>(options: UsePaginatedQueryOptions<T> = {}) {
    return usePaginatedQuery<T>("transactions", {
