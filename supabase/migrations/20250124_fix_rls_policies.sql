...
DROP POLICY IF EXISTS "Admins have full access" ON coupons;
DROP POLICY IF EXISTS "Admins have full access" ON coupon_applicability;
...
DROP POLICY IF EXISTS "Admins have full access" ON transaction_coupons;
DROP POLICY IF EXISTS "Admins have full access" ON user_coupons;
